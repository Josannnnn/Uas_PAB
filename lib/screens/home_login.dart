import 'package:casacraft/screens/favorite_login.dart';
import 'package:casacraft/screens/profile_login.dart';
...
class _HomeLoginPageState extends State<HomeLoginPage> {
  ...
  void _onTabTapped(int index) {
    ...
    if (index == 0) {
      ...
      page = const FavoriteLoginPage();
    } else {
      page = const ProfileLoginPage();
    }
                          ...
                          MaterialPageRoute(
                            builder: (context) => const PropertiBaruDetailPage(
                              property: {
                                ...
                                'description': 'Rumah impian dengan 2 kamar tidur, 3 kamar mandi, dan 1 dapur.',
                                'price': '2.000.000.000',
                          ...
                          MaterialPageRoute(
                            builder: (context) => const PropertiBaruDetailPage(
                              property: {
                                ...
                                'type': '01',
                                'location':
                                    'Jl. Kebagusan Raya No.10, RT.3/RW.5, Kebagusan, Kec. Pasar Minggu, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12520',
                                'description': 'Hunian nyaman dengan 3 kamar tidur, 2 kamar mandi, dan taman luas.',
                                'price': '1.000.000.000',
